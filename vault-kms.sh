...
WRAP=$(vault write -wrap-ttl=100m -f -format=json auth/approle/role/$ROLE/secret-id | jq -r .wrap_info.token)
echo "ROLE_ID=$ROLE_ID"
echo "SECRET_ID=$SECRET_ID"
echo "WRAP=$WRAP"
# Result:
ROLE_ID=78b6ce88-0401-05c7-3f96-0d54d561dea5
SECRET_ID=b3dfbd51-6b92-3647-4123-711b5391244c
WRAP=hvs.CAESIHN-_OUJkjjsOpOzMX3H6cVaMDTA2RiZSbaTFQNeJqwsGh4KHGh2cy5pREVydGxEa0FhTXhIa3o2UFFQZlJwT24

VAULT_TOKEN="$WRAP" vault write -format=json -f sys/wrapping/lookup | jq .
